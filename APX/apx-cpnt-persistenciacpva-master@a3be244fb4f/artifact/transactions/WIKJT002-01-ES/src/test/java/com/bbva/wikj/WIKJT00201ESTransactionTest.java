...
/**
 * Test for transaction WIKJT00201ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT00201ESTest.xml" })
public class WIKJT00201ESTransactionTest {

	@Autowired
	private WIKJT00201ESTransaction transaction;
